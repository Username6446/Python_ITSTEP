...
# print(stud['name2'])  # при неправильному поввертає KeyError
# print(stud.get('surname2')) # при неправильному поввертає 0

stud['name'] = 'Pavlo'
# print(stud['name'])

stud['group'] = "PV521" # при доступу до неіснуючої вона додасться 
# print(stud['group'])
...
def printStudent(student):
    ...
    # print(f"Date :: {student['date']['day']}/{student['date']['mounth']}/{student['date']['year']}")
...
# print(list(map(lambda x: x['age'] + 1, group)))
