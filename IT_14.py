...
# # printPrice(lowPrices(prices), "After :: ")

# # printPrice(list(map(low ,prices)))
...
#                 return True
#             elif flag[0][i]==1 and flag[1][i]==1 and flag[2][i]==1:
#                 return True
#         if (flag[0][0]==1 and flag[1][1]==1 and flag[2][2]==1) or (flag[0][2]==1 and flag[1][1]==1 and flag[2][0]==1):
#                 return True
#     elif player=="bot":    
#         for i in range(3):
#             if flag[i][0]==2 and flag[i][1]==2 and flag[i][2]==2:
#                 return True
#             elif flag[0][i]==2 and flag[1][i]==2 and flag[2][i]==2:
#                 return True
#         if (flag[0][0]==2 and flag[1][1]==2 and flag[2][2]==2) or (flag[0][2]==2 and flag[1][1]==2 and flag[2][0]==2):
#                 return True
#     else:
#         return False
